...
class DetailsAgent:
    ...
    def get_closest_results(self, index_name, input_embemddings, top_k=2):
        index = self.pc.Index(index_name)

        results = index.query(
            namespace="ns1",
            vector=input_embemddings,
            top_k=top_k,
    ...
    def get_response(self, messages):
        ...
        embedding = get_embedding(self.embedding_client, self.model_name, user_message)[
            0
        ]
